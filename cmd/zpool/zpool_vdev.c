 ...
 *
 * The intent is to be able to generate a good configuration with no
 ...
 * defaults are used.  The optional components may appear in any order
 * but the dD/sS/cC suffix is required.
 *
 * Valid inputs:
